...
awful.util.tagnames = {'  愛  ', '  一  ','  二  ','  三  ','  四  ','  五  ','  六  ','  七  ','  八  ','  九  ', s, awful.layout.suit.tile}
...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -g 10  -l 48  -p Run:",
...
--awesome.connect_signal(
    --'exit',
    --function(args)
        --awful.util.spawn('bash -c ~/.start.sh')
    --end
--)
...
awful.spawn.with_shell("./start.sh")
