...
theme.font                                      = "Jetbrains nerd mono 8"
theme.taglist_font                              = "Jetbrains Nerd mono 10"
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 20, bg = theme.bg_normal, fg = theme.fg_normal, opacity = 0.95 })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            --arrow("alpha", "#88C0D0"),
            --wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, 3, 6), "#88C0D0"),
            arrow( "alpha","#5E81AC"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#5E81AC"),
            arrow("#5E81AC", "#B48EAD"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#B48EAD"),
            arrow("#B48EAD", "#5E81AC"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#5E81AC"),
            arrow("#5E81AC", "#B48EAD"),
            --wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, 4, 4), "#B48EAD"),
            --arrow("#B48EAD", "#5E81AC"),
            --wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#5E81AC"),
            --arrow("#5E81AC", "#B48EAD"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#B48EAD"),
            arrow("#B48EAD", "#5E81AC"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#5E81AC"),
            arrow("#5E81AC", "#B48EAD"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#B48EAD"),
            arrow("#B48EAD", "alpha"),
            --]]
            s.mylayoutbox,
        },
